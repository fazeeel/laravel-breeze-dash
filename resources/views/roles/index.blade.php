<x-app-layout>
    ...
    <div class="py-12">
        ...
        <a href="{{route('roles.create')}}" class=" inline-flex items-center px-4 py-2 bg-blue-800 border border-transparent 
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        @foreach($roles as $role)
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="py-4 px-6">
                    <div class="flex">
                   <a href="{{route('roles.edit',$role->id)}}" class="inline-flex items-center px-4 py-2 bg-yellow-500 border border-transparent 
...
<form method="post" class="flex" action="{{route('roles.destroy',$role->id)}}">
    @csrf
    @method('delete')
<button class="
...
<a href="{{route('roles.assign',$role->id)}}" class="inline-flex items-center px-4 py-2 bg-green-400 border border-transparent 
